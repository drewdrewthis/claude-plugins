...
- **From the deep-reflect procedure** (`references/procedures/research-think/deep-reflect/PROCEDURE.md`) — when reflection identifies procedures that were used in analyzed sessions
- **From the done-gate** — when a deviation OR a missing/broken ref surfaced this turn against a documented procedure (`WHAT_DONE_LOOKS_LIKE.md`)
