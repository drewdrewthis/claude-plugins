---
name: take-note
description: Jot a note on your daily scratchpad (~/workspace/notes/YYYY-MM-DD.md). Use for in-flight plans, agreements with your person, open threads, working context worth surviving the day — the yellow legal pad, NOT durable memory. New day = new file with still-relevant items carried forward.
user-invocable: true
...
One markdown file per day at `~/workspace/notes/YYYY-MM-DD.md`. This is the
